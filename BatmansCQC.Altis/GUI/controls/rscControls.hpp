...
class CQC_RscCombo {
	...
	class ComboScrollBar: CQC_ScrollBar {
		color[] = {1,1,1,1};
	};
};
...
class CQC_RscListBox {
	...
	class ListScrollBar: CQC_ScrollBar {
		color[]			  = {1,1,1,1};
		autoScrollEnabled = 1;
	};
};
...
class CQC_RscControlsGroup {
	...
	shadow 	= 0;
	style 	= 16;
	class CQC_VScrollbar: CQC_ScrollBar {
		width 			  = 0.021;
		autoScrollEnabled = 1;
	};
	class CQC_HScrollbar: CQC_ScrollBar {
		height = 0.028;
	};
	class Controls {};
};
...
class CQC_RscControlsGroupNoScrollbars: CQC_RscControlsGroup {
	class VScrollbar: CQC_VScrollbar {
		width = 0;
	};
	class HScrollbar: CQC_HScrollbar {
		height = 0;
	};
};
...
class CQC_RscTree {
	...
	colorPictureRightDisabled[] = {1, 1, 1, 0.25};
	class ScrollBar: CQC_ScrollBar {};
};

class CQC_RscTiles: CQC_RscControlsGroupNoScrollbars {
	idc                 = 115099;
	x                   = "safezoneX";
	y                   = "safezoneY";
	w                   = "safezoneW";
	...
	onLoad              = "[ctrlParent (_this select 0), 'CQC_displayPause'] call (uiNamespace getVariable 'BIS_fnc_guiEffectTiles')";
	class Controls {
...
class CQC_RscDefaultButton: CQC_RscDefault {
...
class CQC_RscButton: CQC_RscDefaultButton {
	type 						= 1;
	style 						= "0x02 + 0xC0";
	colorBackground[] 			= {0, 0, 0, 1};
...
class CQC_RscButtonPictureKeepAspect: CQC_RscButton {
	style 						= "0x02 + 0x30 + 0x800";
};
class CQC_RscButtonToolbar: CQC_RscButtonPictureKeepAspect {
	colorBackground[] 			= {0, 0, 0, 0};
	colorBackgroundDisabled[] 	= {0, 0, 0, 0};
};
