...
class CQC_ctrlSliderV: CQC_ctrlDefault {
	type = 3;
	style = 0;
	color[] = {0,0,0,1};
...
class CQC_ctrlSliderH: CQC_ctrlSliderV {
	style = 1024;
};

class CQC_ctrlXSliderV: CQC_ctrlDefault {
	type = 43;
	style = 0;
	color[] = {1,1,1,0.6};
	colorActive[] = {1,1,1,1};
...
class CQC_ctrlXSliderH: CQC_ctrlXSliderV {
	style = 1024;
};
