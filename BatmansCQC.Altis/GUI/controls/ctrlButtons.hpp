...
class CQC_ctrlDefaultButton0: CQC_ctrlDefaultText {
    soundClick[] = {
...
class CQC_ctrlDefaultButton: CQC_ctrlDefaultButton0 {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
...
class CQC_ctrlFloatButton: CQC_ctrlDefaultButton0 {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
    sizeEx 						= TEXT_SIZE_CONTENTBUTTON;
...
class CQC_ctrlContentAreaButton: CQC_ctrlDefaultButton {
    type						= CT_BUTTON;
    style 						= ST_CENTER;
    sizeEx 						= TEXT_SMALL2;
...
class CQC_ctrlContentAreaTexturedButton: CQC_RscButtonMenu {
...
class CQC_ctrlButtonClose: CQC_ctrlButtonToolbar {
    idc            = -1;
    style          = "0x02 + 0x30 + 0x800";
...
class CQC_ctrlButtonClose3DEN: CQC_ctrlButtonToolbar {
    idc            = -1;
    style          = "0x02 + 0x30 + 0x800";
    text           = "\a3\3DEN\Data\Displays\Display3DEN\search_end_ca.paa";
    w           = "5 * (pixelW * pixelGrid * 0.50)";
...
class CQC_ctrlShortcutButton: CQC_ctrlDefaultButton {
    type = 16;
    style = ST_UPPERCASE;
    colorBackground[] = {0,0,0,1};
